...
def _attach_evidence_context(text: str, retrieved_evidence: list[dict] | None) -> str:
...
def _sanitize_candidate(candidate: Dict[str, Any], retrieved_evidence: list[dict] | None = None) -> Dict[str, Any]:
